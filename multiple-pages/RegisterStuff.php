            ...
            <div class="form"  style="text-align:center; border-radius:10px;">
              <form action="" method="post" id="contactFrm" name="contactFrm" enctype="multipart/form-data">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        <td style="color:#fff;"><input type="file" required placeholder="Qualification Copy" value="" name="myfile" class="txt"></td>
                        <td style="color:#fff;"><input type="file" required placeholder="ID Copy" value="" name="myfile" class="txt"></td>
                    </tr>
                </table>
                <hr/>
                <table style="width:100%;">
                    ...
                    <tr>
                    	 <td style="color:#fff;"><input type="file" required placeholder="Profile photo" value="" name="myfile" class="txt"></td>
                    </tr>
                </table>
                <hr/>
